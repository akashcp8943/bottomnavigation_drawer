...
class _Reg2State extends State<Reg2> {
  ...
  Future<void>name1() async {
   ...
   Future<void> name2() async {
     final sp = await SharedPreferences.getInstance();
     var a = sp.getString('name');
     print(a);
   }
  Future<void> name3() async {
    final sp = await SharedPreferences.getInstance();
    var b = sp.getString('email');
    print(b);
  }
  Future<void> name4() async {
    final sp= await SharedPreferences.getInstance();
    var c = sp.getString('password');
    print(c);
  }
